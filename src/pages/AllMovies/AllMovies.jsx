    ...
    <main className="min-h-screen bg-[#0d0d0d] px-4 py-12 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mb-6 max-w-xl text-sm text-gray-400 sm:text-base">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-[#171717] py-3 pl-11 pr-4 text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-500"
            />
          </div>
        </div>
